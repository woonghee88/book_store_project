...
<%
	  ...
	  session.setAttribute("password", "p1");
		            ...
		            <div class="col-md-12">
                        <div class="wishlist-table-area table-responsive">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="product-remove">주문 취소</th>
                                        <th class="product-number">주문 번호</th>
                                        <th class="product-image">이미지</th>
                                        <th class="t-product-name"> 도서명 </th>
                                        <th class="product-quantity">수량</th>
                                        <th class="product-subtotal">총 금액</th>
                                        <th class="order-date">주문 일자</th>
                                        <th class="delivery-status">배송상태</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody> 
    								...
    								<tr>
       								<td colspan="8">
           							<p align="center" style="margin:10px;"><b><span style="font-size:13pt;  ">등록된 게시물이 없습니다.</span></b></p>
       									 </td>
   									 </tr>
	    							</c:when>
    								<c:otherwise>
                                    ...
                                    <tr>
                                        <td class="product-remove">
                                          ...
                                          <td class="product-number">
											<p><span style="font-size:9pt;">${bookDto.orderNo}</span></p>
										</td>
                                        ...
                                        <td class="t-product-name">
                                            <h3>
                                                <a href="#">${booktDto.detail.bookName}</a>
                                            </h3>
                                        </td>
                                        <td class="product-quantity">
                                            <p><span style="font-size:9pt;">${bookDto.detailorderProductQuantity}</span>                          
                                            </p>
                                        </td>
                                        <td class="product-subtotal">
                                            <p><span style="font-size:9pt;">${bookDto.totalPrice}</span></p>
                                        </td>
                                  		<td class="order-date">
                                      		<p><span style="font-size:9pt;">${bookDto.orderDt}</span> </p>
                                      	</td>
										<td class="delivery-status">
											<p><span style="font-size:9pt;">${bookDto.delivery.deliveryStaus}</span></p>
										</td>
                                    </tr> <!--  끝  -->
                                 	</c:forEach>
									</c:otherwise>
